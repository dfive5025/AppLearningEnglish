 ...
 * @author Admin
 */
public class GameHomeView extends javax.swing.JFrame {
    ...
    private void btnVocabularyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVocabularyActionPerformed
        if (new GameHomeCtl().getWordQuanlity() >= 10) {
            ...
            WarningtAnnounce("Must have at least 10 words to play vocabulary's game");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameHomeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameHomeView().setVisible(true);
            }
        });
    }
